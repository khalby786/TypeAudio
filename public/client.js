(function() {
  ...
  function insertTimestamp() {
    document.execCommand(
      "insertHTML",
      false,
      '<span class="timestamp" contenteditable="false" data="hi" onclick="var x = this; setFromTimestamp(\'' +
        getTimestamp() +
        "', x);\">" +
        getTimestamp() +
        "</span>&nbsp;"
  ...
  function html5Support() {
    ...
    if (audioTagSupport && contentEditableSupport) {
      return true;
    } else {
      return false;
    }
    ...
    return (
      (a.prototype.initMedia = function() {
        this._media.addEventListener(
          ...
          this._media.addEventListener(
            "timeupdate",
            this.updateTimeCount.bind(this),
            !1
          ),
          this.addClickEvents(),
          this.updateTimeCount(this._media);
      }),
      (a.prototype.initProgressBar = function() {
      ...
      (a.prototype.updateProgress = function() {
        ...
        this._media.currentTime > 0 &&
          (a = (100 / this._media.duration) * this._media.currentTime),
          (this._bar.getElementsByTagName("div")[0].style.width = a + "%");
      }),
      (a.prototype.formatTime = function(a) {
        var b = Math.floor(a / 60),
          c = ("0" + Math.round(a - 60 * b)).slice(-2);
        return b + ":" + c;
      }),
      (a.prototype.updateTimeCount = function() {
        if (this._time) {
          var a = this.formatTime(this._media.currentTime),
            b = this.formatTime(this._media.duration);
          isNaN(this._media.duration) === !0 && (b = "00:00"),
            (this._time.innerHTML = a + "/" + b);
        }
      }),
      (a.prototype.timeFromCursorPosition = function(a, b, c) {
        var d = a.getBoundingClientRect(),
          e = b.clientX - d.left,
          f = e / d.width;
        return f * c;
      }),
      (a.prototype.setMediaProgress = function(a) {
      ...
      (a.prototype.addClickEvents = function() {
        var a = !1,
          b = !1,
          c = "",
          d = function(c) {
            (a = !0),
              (b = !this._media.paused),
              this._media.pause(),
              this.setMediaProgress(c);
          },
          e = function() {
            clearInterval(c),
              (a = !1),
              1 == b && (this._media.play(), (b = !1));
          },
          f = function(b) {
            a === !0 && (c = setInterval(this.setMediaProgress(b), 1e3));
          };
        this._bar.addEventListener("mousedown", d.bind(this)),
          document.addEventListener("mouseup", e.bind(this)),
          document.addEventListener("mousemove", f.bind(this));
      }),
      a
    );
  });
